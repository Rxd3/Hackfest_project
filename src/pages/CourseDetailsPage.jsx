...
export function CourseDetailsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section>
        <h2 className="mb-4 text-xl font-extrabold text-ink">Lectures</h2>
    ...
    <>
      <section className="soft-card p-5">
        ...
        <div className="mt-5 space-y-3 text-sm font-bold text-muted">
          <p>Completed: {modules.filter((module) => module.progress >= 100).length} / {modules.length} lectures</p>
      ...
      <section className="soft-card p-5">
        ...
        <p className="mt-3 text-sm font-semibold leading-6 text-muted">
          {nextModule ? `Continue ${nextModule.title} and complete the quiz.` : "Create a lecture to continue."}
        </p>

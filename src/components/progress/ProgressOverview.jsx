    ...
    <SectionCard>
      <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
        ...
        <div className="grid grid-cols-1 gap-3 text-sm font-bold text-muted sm:grid-cols-3">
          <span className="rounded-2xl bg-gray-50 px-4 py-3">Completed: {completed} lectures</span>
          <span className="rounded-2xl bg-gray-50 px-4 py-3">Remaining: {Math.max(0, modules.length - completed)} lectures</span>
